...
class LanGuideMedSegWrapper(pl.LightningModule):
    ...
    def __init__(self, args):
        ...
        metrics_dict = {"dice_micro":Dice(average='micro',ignore_index=0),"dice_macro":Dice(average='macro',num_classes=4,ignore_index=0),
                        "dice_class0":Dice(average='none',num_classes=4,ignore_index=0)[0],
                        "dice_class1":Dice(average='none',num_classes=4,ignore_index=0)[1],
                        "dice_class2":Dice(average='none',num_classes=4,ignore_index=0)[2],
                        "dice_class3":Dice(average='none',num_classes=4,ignore_index=0)[3]
                        }  #Without bg
